...
def add_exception_handlers(app: FastAPI) -> None:
    ...
    async def app_exception_handler(request: Request, exc: AppException) -> JSONResponse:
        ...
        return JSONResponse(
            status_code=500,
            content={"detail": str(exc), "type": "app_error"}
        )
    ...
    async def auth_exception_handler(request: Request, exc: AuthorizationError) -> JSONResponse:
    ...
    async def db_exception_handler(request: Request, exc: DatabaseError) -> JSONResponse:
    ...
    async def not_found_exception_handler(request: Request, exc: ProductNotFoundError) -> JSONResponse:
    ...
    async def funds_exception_handler(request: Request, exc: InsufficientFundsError) -> JSONResponse:
    ...
    async def ml_exception_handler(request: Request, exc: MLServiceError) -> JSONResponse:
    ...
    async def queue_exception_handler(request: Request, exc: TaskQueueError) -> JSONResponse:
